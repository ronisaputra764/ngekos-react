...
export default function Cities({ boardingHouse, cities, formatRupiah }) {

    const { id } = useParams();

    const cityName = cities.find((city) => city.id === id);
    const filteredBoardingHouse = boardingHouse.filter((house) => house.city_id === id);
            ...
            >
                ...
                >
                    <div className="flex flex-col gap-[6px]">
                        <h1 className="font-bold text-[32px] leading-[48px]">{cityName.name} City</h1>
                                ...
                                <div className="flex flex-col gap-3 w-full">
                                    ...
                                    <div className="flex items-center gap-[6px]">
                                        <img
                                            ...
                                            alt="icon"
                                        />
                                        <p className="text-sm text-ngekos-grey">{cityName.name} City</p>
                                    </div>
                                    <div className="flex items-center gap-[6px]">
                                        <img
